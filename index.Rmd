...
* We investigated the potential bene`fit of long wavelength sensitivity by modelling the visual contrast in representative insect vision.
...
```{r, fig.cap="Reflectance spectra of samples used in the visual models"}
