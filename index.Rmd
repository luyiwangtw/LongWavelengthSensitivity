...
In this online document, we describe the analyses and results of visual models and behavioural assays in the paper "". We provide the code for users to run the analyses step-by-step, and produce the figures from the manuscript.
...
2. [Even space](even_space.html) : Test for the effect of evenly spaced photoreceptors on chromatic contrast.

3. [Sensitivity analysis](sensitivity_analysis.html): Test if the modelling results are sensitive to photoreceptor ratio.

4. [Behavioural assay](behairoual_assay.html): Details about the behavioural assay which we tested if the living jewel beetles could respond to long wavelength light.
