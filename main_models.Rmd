...
twilight.vismodel.output <- d65.vismodel.output # replicate a same list for twilight
...
## Twilight - Aim 2
### flower vs leaf
vislist.fl_d65.aim2 <- list("bup580.flower.vs.leaf_twilight",
...
### beetle vs leaf
vislist.bl_d65.aim2 <- list("bup580.beetle.vs.leaf_twilight",
...
### beetle vs flower
vislist.bf_d65.aim2 <- list("bup580.beetle.vs.flower_twilight",
...
m.beetle.vs.leaf_d65.aim1 <- lmer(dS ~ peak_wl.beetle.vs.leaf + (1|patch2) + (1|patch1), 
                                  data = compare.beetle.vs.leaf.aim1, REML = F)
...
m.flower.vs.leaf_d65.aim2 <- lmer(dS~peak_wl.flower.vs.leaf + (1|patch2) + (1|patch1), 
                                  data = compare.flower.vs.leaf.aim2, REML = F)
...
m.beetle.vs.leaf_d65.aim2 <- lmer(dS ~ peak_wl.beetle.vs.leaf + (1|patch2) + (1|patch1), 
                                  data = compare.beetle.vs.leaf.aim2, REML = F)
...
m.beetle.vs.flower_d65.aim2 <- lmer(dS ~ peak_wl.beetle.vs.flower + (1|patch2) + (1|patch1), 
                                    data = compare.beetle.vs.flower.aim2, REML = F)
...
m.flower.vs.leaf_twilight.aim1 <- lmer(dS ~ peak_wl.flower.vs.leaf + (1|patch2) + (1|patch1), 
                                       data = compare.flower.vs.leaf_twilight.aim1, REML = F)
...
m.beetle.vs.leaf_twilight.aim1 <- lmer(dS ~ peak_wl.beetle.vs.leaf + (1|patch2) + (1|patch1), 
                                       data = compare.beetle.vs.leaf_twilight.aim1, REML = F)
...
m.beetle.vs.flower_twilight.aim1 <- lmer(dS ~ peak_wl.beetle.vs.flower + (1|patch2) + (1|patch1), 
                                         data = compare.beetle.vs.flower_twilight.aim1, REML = F)
...
m.flower.vs.leaf_twilight.aim2 <- lmer(dS ~ peak_wl.flower.vs.leaf + (1|patch2) + (1|patch1), 
                                       data = compare.flower.vs.leaf_twilight.aim2, REML = F)
...
m.beetle.vs.leaf_twilight.aim2 <- lmer(dS ~ peak_wl.beetle.vs.leaf + (1|patch2) + (1|patch1), 
                                       data = compare.beetle.vs.leaf_twilight.aim2, REML = F)
...
m.beetle.vs.flower_twilight.aim2 <- lmer(dS ~ peak_wl.beetle.vs.flower + (1|patch2) + (1|patch1), 
                                         data = compare.beetle.vs.flower_twilight.aim2, REML = F)
...
```{r}
m.flower.vs.leaf_d65.aim1 <- 
  lmer(dS ~ peak_wl.flower.vs.leaf + (1|patch2) + (1|patch1), 
       data = compare.flower.vs.leaf.aim1, REML=F)
m.flower.vs.leaf_twilight.aim1 <- 
  lmer(dS ~ peak_wl.flower.vs.leaf + (1|patch2) + (1|patch1), 
       data = compare.flower.vs.leaf_twilight.aim1, REML=F)
```
...
get.contrastplot <- function(dat, title, vislable, upperylim, visomplist, compgroupnstats){
  ggplot(dat, aes(x = vissys, 
    ...
    theme(panel.grid.major = element_blank(), 
          ...
          panel.background = element_rect(fill = "grey80", size = NA), 
...
fl_d65.aim1 <- get.contrastplot(mean.fl_d65.aim1, 1, 1, 1, 1, 1) # flower vs leaf
bl_d65.aim1 <- get.contrastplot(mean.bl_d65.aim1, 2, 1, 1, 2, 2) # beetle vs leaf
bf_d65.aim1 <- get.contrastplot(mean.bf_d65.aim1, 3, 1, 1, 3, 3) # beetle vs flower
...
# plot individual panel
fl_twilight.aim1 <- get.contrastplot(mean.fl_twilight.aim1, 1, 1, 2, 1, 7)
bl_twilight.aim1 <- get.contrastplot(mean.bl_twilight.aim1, 2, 1, 2, 2, 8)
bf_twilight.aim1 <- get.contrastplot(mean.bf_twilight.aim1, 3, 1, 2, 3, 9)
...
# plot individual panel
fl_d65.aim2 <- get.contrastplot(mean.fl_d65.aim2, 1, 2, 1, 4, 4)
bl_d65.aim2 <- get.contrastplot(mean.bl_d65.aim2, 2, 2, 1, 5, 5)
bf_d65.aim2 <- get.contrastplot(mean.bf_d65.aim2, 3, 2, 1, 6, 6)
...
# plot individual panel
fl_twilight.aim2 <- get.contrastplot(mean.fl_twilight.aim2, 1, 2, 2, 4, 10)
bl_twilight.aim2 <- get.contrastplot(mean.bl_twilight.aim2, 2, 2, 2, 5, 11)
bf_twilight.aim2 <- get.contrastplot(mean.bf_twilight.aim2, 3, 2, 2, 6, 12)
