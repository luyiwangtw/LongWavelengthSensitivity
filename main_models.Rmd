...
specsensbuprest.model1 <- read.csv("data/peak sensitivity_filter shift_aim1.csv",header=TRUE) %>%
  as.rspec()
...
```{r, fig.cap="Relative irradiance of standard daylight and twilight"}
...
CvisUVSWMW.. = coldist(visUVSWMW.., noise="neural", achro=FALSE, n = c(1.6027, 1.4059, 1.7714), weber = 0.0883, weber.ref = 3) 
CvisUV..MWLW = coldist(visUV..MWLW, noise="neural", achro=FALSE, n = c(1.4416, 1.5933, 1.7451), weber = 0.0889, weber.ref = 3)
CvisUVSW..LW = coldist(visUVSW..LW, noise="neural", achro=FALSE, n = c(1.5481, 1.3580, 1.8740), weber = 0.0858, weber.ref = 3)
...
CvisUVSWMW.._twilight = coldist(visUVSWMW.._twilight, noise="quantum", achro=FALSE, n = c(1.6027, 1.4059, 1.7714), weber = 0.0883, weber.ref = 3)  
CvisUV..MWLW_twilight = coldist(visUV..MWLW_twilight, noise="quantum", achro=FALSE, n = c(1.4416, 1.5933, 1.7451), weber = 0.0889, weber.ref = 3)
CvisUVSW..LW_twilight = coldist(visUVSW..LW_twilight, noise="quantum", achro=FALSE, n = c(1.5481, 1.3580, 1.8740), weber = 0.0858, weber.ref = 3)
CvisUVSWMWLW_twilight = coldist(visUVSWMWLW_twilight, noise="quantum", achro=FALSE, n = c(1.14,1,1.26,1.38), weber = 0.1,  weber.ref = 4)
...
allvis.lf_d65.model2<-Vis1.lf_d65.model2 %>% rbind(Vis2.lf_d65.model2) %>% rbind(Vis3.lf_d65.model2) %>%
  rbind(Vis4.lf_d65.model2) %>%rbind(Vis5.lf_d65.model2)
...
allvis.lb_d65.model2<-Vis1.lb_d65.model2 %>% rbind(Vis2.lb_d65.model2) %>% rbind(Vis3.lb_d65.model2) %>%
  rbind(Vis4.lb_d65.model2) %>%rbind(Vis5.lb_d65.model2) 
...
allvis.bf_d65.model2<-Vis1.bf_d65.model2 %>% rbind(Vis2.bf_d65.model2) %>% rbind(Vis3.bf_d65.model2) %>%
  rbind(Vis4.bf_d65.model2) %>%rbind(Vis5.bf_d65.model2) 
...
allvis.lf_twilight.model2<-Vis1.lf_twilight.model2 %>% rbind(Vis2.lf_twilight.model2) %>% rbind(Vis3.lf_twilight.model2) %>%
  rbind(Vis4.lf_twilight.model2) %>%rbind(Vis5.lf_twilight.model2)
...
allvis.lb_twilight.model2<-Vis1.lb_twilight.model2 %>% rbind(Vis2.lb_twilight.model2) %>% rbind(Vis3.lb_twilight.model2) %>% rbind(Vis4.lb_twilight.model2) %>%rbind(Vis5.lb_twilight.model2)
...
allvis.bf_twilight.model2<-Vis1.bf_twilight.model2 %>% rbind(Vis2.bf_twilight.model2) %>% rbind(Vis3.bf_twilight.model2) %>% rbind(Vis4.bf_twilight.model2) %>%rbind(Vis5.bf_twilight.model2)
```
...
The table shows the median contrast in each comparison group
```{r}
system.list.model2<- rbind.data.frame("Vis 580", "Vis 600", "Vis 620", "Vis 640", "Vis 660") %>% rename(system = 1) # make a list of system names
```
####Daylight
```{r}
#Daylight
##list contrast from each comparison group
lf.contrast_d65.model2 <- rbind.data.frame(median(Vis1.lf_d65.model2$dS), median(Vis2.lf_d65.model2$dS),median(Vis3.lf_d65.model2$dS),median(Vis4.lf_d65.model2$dS),median(Vis5.lf_d65.model2$dS))
lb.contrast_d65.model2 <-rbind.data.frame(median(Vis1.lb_d65.model2$dS),median(Vis2.lb_d65.model2$dS),median(Vis3.lb_d65.model2$dS),median(Vis4.lb_d65.model2$dS),median(Vis5.lb_d65.model2$dS))
bf.contrast_d65.model2 <-rbind.data.frame(median(Vis1.bf_d65.model2$dS), median(Vis2.bf_d65.model2$dS),median(Vis3.bf_d65.model2$dS),median(Vis4.bf_d65.model2$dS),median(Vis5.bf_d65.model2$dS))
#combind comparison groups together in a table
...
#Twilight
##list contrast from each comparison group
lf.contrast_twilight.model2 <- rbind.data.frame(median(Vis1.lf_twilight.model2$dS), median(Vis2.lf_twilight.model2$dS),median(Vis3.lf_twilight.model2$dS),median(Vis4.lf_twilight.model2$dS),median(Vis5.lf_twilight.model2$dS))
lb.contrast_twilight.model2 <-rbind.data.frame(median(Vis1.lb_twilight.model2$dS),median(Vis2.lb_twilight.model2$dS),median(Vis3.lb_twilight.model2$dS),median(Vis4.lb_twilight.model2$dS),median(Vis5.lb_twilight.model2$dS))
bf.contrast_twilight.model2 <-rbind.data.frame(median(Vis1.bf_twilight.model2$dS), median(Vis2.bf_twilight.model2$dS),median(Vis3.bf_twilight.model2$dS),median(Vis4.bf_twilight.model2$dS),median(Vis5.bf_twilight.model2$dS))
#combind comparison groups together in a table
...
com.bupcontrast.leaf.vs.flower.model2<-cbind(Cbuprest.leaf.vs.flower.model2[,1:2],bup580.leaf.vs.flower,bup600.leaf.vs.flower,bup620.leaf.vs.flower,bup640.leaf.vs.flower,bup660.leaf.vs.flower)
...
com.bupcontrast.leaf.vs.beetle.model2<-cbind(Cbuprest.leaf.vs.beetle.model2[,1:2],bup580.leaf.vs.beetle,bup600.leaf.vs.beetle,bup620.leaf.vs.beetle,bup640.leaf.vs.beetle,bup660.leaf.vs.beetle)
...
com.bupcontrast.flower.vs.beetle.model2<-cbind(Cbuprest.flower.vs.beetle.model2[,1:2],bup580.flower.vs.beetle,bup600.flower.vs.beetle,bup620.flower.vs.beetle,bup640.flower.vs.beetle,bup660.flower.vs.beetle)
...
Cbuprest.leaf.vs.flower_twilight.model2=
  ...
  rbind(Cbuprest620.leaf.vs.flower_twilight)%>% rbind(Cbuprest640.leaf.vs.flower_twilight) %>% rbind(Cbuprest660.leaf.vs.flower_twilight)
...
com.bupcontrast.leaf.vs.flower_twilight.model2<-cbind(Cbuprest.leaf.vs.flower_twilight.model2[,1:2],bup580.leaf.vs.flower_twilight,bup600.leaf.vs.flower_twilight,bup620.leaf.vs.flower_twilight,bup640.leaf.vs.flower_twilight,bup660.leaf.vs.flower_twilight)
...
Cbuprest.leaf.vs.beetle_twilight.model2=
  ...
  rbind(Cbuprest660.leaf.vs.beetle_twilight)
...
com.bupcontrast.leaf.vs.beetle_twilight.model2<-cbind(Cbuprest.leaf.vs.beetle_twilight.model2[,1:2],bup580.leaf.vs.beetle_twilight,bup600.leaf.vs.beetle_twilight,bup620.leaf.vs.beetle_twilight,bup640.leaf.vs.beetle_twilight,bup660.leaf.vs.beetle_twilight)
...
Cbuprest.flower.vs.beetle_twilight.model2=
  ...
  rbind(Cbuprest660.flower.vs.beetle_twilight)
...
com.bupcontrast.flower.vs.beetle_twilight.model2<-cbind(Cbuprest.flower.vs.beetle_twilight.model2[,1:2],bup580.flower.vs.beetle_twilight,bup600.flower.vs.beetle_twilight,bup620.flower.vs.beetle_twilight,bup640.flower.vs.beetle_twilight,bup660.flower.vs.beetle_twilight)
...
boxplot(compare.leaf.vs.flower.model2$dS~compare.leaf.vs.flower.model2$peak_wl.leaf.vs.flower, las=2,
        main = "Leaf vs Flower",
        names=c("Vis 580", "Vis 600", "Vis 620", "Vis 640", "Vis 660"))
...
VislistB_d65.model1<-c("Vis UML", "Vis UML","Vis UML","Vis USL","Vis USL","Vis USM")
...
VislistA_d65.model2<-c("Vis 600", "Vis 620","Vis 640","Vis 660","Vis 620","Vis 640","Vis 660","Vis 640","Vis 660","Vis 660")
VislistB_d65.model2<-c("Vis 580","Vis 580","Vis 580","Vis 580","Vis 600","Vis 600","Vis 600","Vis 620","Vis 620","Vis 640")
...
VislistB_twilight.model1<-c("Vis UML", "Vis UML","Vis UML","Vis USL","Vis USL","Vis USM")
...
VislistA_twilight.model2<-c("Vis 600", "Vis 620","Vis 640","Vis 660","Vis 620","Vis 640","Vis 660","Vis 640","Vis 660","Vis 660")
VislistB_twilight.model2<-c("Vis 580","Vis 580","Vis 580","Vis 580","Vis 600","Vis 600","Vis 600","Vis 620","Vis 620","Vis 640")
...
### Results of visual model 1: comparing visual systems with different photoreceptor combinations {.tabset .tabset-fade .tabset-pills}

</br>

Click the tabs to see the results for each comparison group ( __Leaf vs. Flower__ / __Leaf vs. Beetle__ / __Beetle vs. Flower__) and under different light conditions ( __Daylight__ / __Twilight__)
...
### Results of visual model 2: comparing visual systems with different LWS peak sensitivities {.tabset .tabset-fade .tabset-pills}
...
######Pair-wise p-values
```{r}
ggplot(data = heat_twilight.model2, aes(x=VislistA_twilight.model2, y=VislistB_twilight.model2, fill=flower.vs.beetle)) + 
  geom_tile(colour="white", size = 4)+
  geom_text(aes(VislistA_twilight.model2, VislistB_twilight.model2,  label = paste(format(round(flower.vs.beetle, 2), nsmall = 2), sig.flower.vs.beetle)))+
  scale_fill_continuous(high = "#132B43", low = "#56B1F7", limit=c(0,1))+ #delete if want to reverse the colour
  theme_bw()+
  theme(axis.title.x=element_blank(),
        axis.title.y=element_blank(),
...
lf_d65.model1<-ggplot(mean.lf_d65.model1, aes(x=vissys, y=mean.dS.lf,group=flowerID))+
  ...
  geom_point(data = mean.lf_d65.model1, aes(x= "Vis1.lf", y= mean(Vis1.lf_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_d65.model1, aes(x= "Vis2.lf", y= mean(Vis2.lf_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_d65.model1, aes(x= "Vis3.lf", y= mean(Vis3.lf_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_d65.model1, aes(x= "Vis4.lf", y= mean(Vis4.lf_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Leaf vs. Flower")+
  annotate("text", x = c("Vis1.lf", "Vis2.lf", "Vis3.lf","Vis4.lf"), y = 15, label =c("a","a","b","c")) #add stitistical info
...
lb_d65.model1<-ggplot(mean.lb_d65.model1, aes(x=vissys, y=mean.dS.lb,group=beetleID))+
  ...
  scale_x_discrete(limits = c("Vis1.lb", "Vis2.lb", "Vis3.lb","Vis4.lb"),
                   labels=c("Vis USM", "Vis UML", "Vis USL","Vis USML"))+
  geom_hline(yintercept = 1,linetype="dotted")+ ##add a JND=1 line
  geom_point(data = mean.lb_d65.model1, aes(x= "Vis1.lb", y= mean(Vis1.lb_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_d65.model1, aes(x= "Vis2.lb", y= mean(Vis2.lb_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_d65.model1, aes(x= "Vis3.lb", y= mean(Vis3.lb_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_d65.model1, aes(x= "Vis4.lb", y= mean(Vis4.lb_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Leaf vs. Beetle")+annotate("text", x = c("Vis1.lb", "Vis2.lb", "Vis3.lb","Vis4.lb"), y = 15, label =c("a","bc","b","c")) #add stitistical info
...
bf_d65.model1<-ggplot(mean.bf_d65.model1, aes(x=vissys, y=mean.dS.bf,group=flowerID))+
  ...
  scale_x_discrete(limits = c("Vis1.bf", "Vis2.bf", "Vis3.bf","Vis4.bf"),
                   labels=c("Vis USM", "Vis UML", "Vis USL","Vis USML"))+
  geom_hline(yintercept = 1,linetype="dotted")+ ##add a JND=1 line
  geom_point(data = mean.bf_d65.model1, aes(x= "Vis1.bf", y= mean(Vis1.bf_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_d65.model1, aes(x= "Vis2.bf", y= mean(Vis2.bf_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_d65.model1, aes(x= "Vis3.bf", y= mean(Vis3.bf_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_d65.model1, aes(x= "Vis4.bf", y= mean(Vis4.bf_d65.model1$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Beetle vs. Flower")+
  annotate("text", x = c("Vis1.bf", "Vis2.bf", "Vis3.bf","Vis4.bf"), y = 15, label =c("a","b","c","d")) #add stitistical info
...
lf_twilight.model1<-ggplot(mean.lf_twilight.model1, aes(x=vissys, y=mean.dS.lf,group=flowerID))+
  ...
  scale_x_discrete(limits = c("Vis1.lf", "Vis2.lf", "Vis3.lf","Vis4.lf"),
                   labels=c("Vis USM", "Vis UML", "Vis USL","Vis USML"))+
  geom_hline(yintercept = 1,linetype="dotted")+ ##add a JND=1 line
  geom_point(data = mean.lf_twilight.model1, aes(x= "Vis1.lf", y= mean(Vis1.lf_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_twilight.model1, aes(x= "Vis2.lf", y= mean(Vis2.lf_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_twilight.model1, aes(x= "Vis3.lf", y= mean(Vis3.lf_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_twilight.model1, aes(x= "Vis4.lf", y= mean(Vis4.lf_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Leaf vs. Flower")+
  annotate("text", x = c("Vis1.lf", "Vis2.lf", "Vis3.lf","Vis4.lf"), y = 3, label =c("a","b","c","d")) #add stitistical info
...
lb_twilight.model1<-ggplot(mean.lb_twilight.model1, aes(x=vissys, y=mean.dS.lb,group=beetleID))+
  ...
  scale_x_discrete(limits = c("Vis1.lb", "Vis2.lb", "Vis3.lb","Vis4.lb"),
                   labels=c("Vis USM", "Vis UML", "Vis USL","Vis USML"))+
  geom_hline(yintercept = 1,linetype="dotted")+ ##add a JND=1 line
  geom_point(data = mean.lb_twilight.model1, aes(x= "Vis1.lb", y= mean(Vis1.lb_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_twilight.model1, aes(x= "Vis2.lb", y= mean(Vis2.lb_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_twilight.model1, aes(x= "Vis3.lb", y= mean(Vis3.lb_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_twilight.model1, aes(x= "Vis4.lb", y= mean(Vis4.lb_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Leaf vs. Beetle")+
  annotate("text", x = c("Vis1.lb", "Vis2.lb", "Vis3.lb","Vis4.lb"), y = 3, label =c("a","b","b","c")) #add stitistical info
...
bf_twilight.model1<-ggplot(mean.bf_twilight.model1, aes(x=vissys, y=mean.dS.bf,group=flowerID))+
  ...
  scale_x_discrete(limits = c("Vis1.bf", "Vis2.bf", "Vis3.bf","Vis4.bf"),
                   labels=c("Vis USM", "Vis UML", "Vis USL","Vis USML"))+
  geom_hline(yintercept = 1,linetype="dotted")+ ##add a JND=1 line
  geom_point(data = mean.bf_twilight.model1, aes(x= "Vis1.bf", y= mean(Vis1.bf_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_twilight.model1, aes(x= "Vis2.bf", y= mean(Vis2.bf_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_twilight.model1, aes(x= "Vis3.bf", y= mean(Vis3.bf_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_twilight.model1, aes(x= "Vis4.bf", y= mean(Vis4.bf_twilight.model1$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Beetle vs. Flower")+
  annotate("text", x = c("Vis1.bf", "Vis2.bf", "Vis3.bf","Vis4.bf"), y = 3, label =c("a","b","c","d")) #add stitistical info
...
lf_d65.model2<-ggplot(mean.lf_d65.model2, aes(x=vissys, y=mean.dS.lf,group=flowerID))+
  ...
  geom_hline(yintercept = 1,linetype="dotted")+ ##add a JND=1 line
  geom_point(data = mean.lf_d65.model2, aes(x= "Vis1.lf", y= mean(Vis1.lf_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_d65.model2, aes(x= "Vis2.lf", y= mean(Vis2.lf_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_d65.model2, aes(x= "Vis3.lf", y= mean(Vis3.lf_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_d65.model2, aes(x= "Vis4.lf", y= mean(Vis4.lf_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_d65.model2, aes(x= "Vis5.lf", y= mean(Vis5.lf_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Leaf vs. Flower")+
...
lb_d65.model2<-ggplot(mean.lb_d65.model2, aes(x=vissys, y=mean.dS.lb,group=beetleID))+
  ...
  scale_x_discrete(limits = c("Vis1.lb", "Vis2.lb", "Vis3.lb","Vis4.lb","Vis5.lb"),
                   labels=c("Vis 580", "Vis 600","Vis 620","Vis 640","Vis 660"))+
  geom_hline(yintercept = 1,linetype="dotted")+ ##add a JND=1 line
  geom_point(data = mean.lb_d65.model2, aes(x= "Vis1.lb", y= mean(Vis1.lb_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_d65.model2, aes(x= "Vis2.lb", y= mean(Vis2.lb_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_d65.model2, aes(x= "Vis3.lb", y= mean(Vis3.lb_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_d65.model2, aes(x= "Vis4.lb", y= mean(Vis4.lb_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_d65.model2, aes(x= "Vis5.lb", y= mean(Vis5.lb_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Leaf vs. Beetle")+
...
bf_d65.model2<-ggplot(mean.bf_d65.model2, aes(x=vissys, y=mean.dS.bf,group=flowerID))+
  ...
  scale_x_discrete(limits = c("Vis1.bf", "Vis2.bf", "Vis3.bf","Vis4.bf","Vis5.bf"),
                   labels=c("Vis 580", "Vis 600","Vis 620","Vis 640","Vis 660"))+
  geom_hline(yintercept = 1,linetype="dotted")+ ##add a JND=1 line
  geom_point(data = mean.bf_d65.model2, aes(x= "Vis1.bf", y= mean(Vis1.bf_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_d65.model2, aes(x= "Vis2.bf", y= mean(Vis2.bf_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_d65.model2, aes(x= "Vis3.bf", y= mean(Vis3.bf_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_d65.model2, aes(x= "Vis4.bf", y= mean(Vis4.bf_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_d65.model2, aes(x= "Vis5.bf", y= mean(Vis5.bf_d65.model2$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Beetle vs. Flower")+
...
lf_twilight.model2<-ggplot(mean.lf_twilight.model2, aes(x=vissys, y=mean.dS.lf,group=flowerID))+
  ...
  scale_x_discrete(limits = c("Vis1.lf", "Vis2.lf", "Vis3.lf","Vis4.lf","Vis5.lf"),
                   labels=c("Vis 580", "Vis 600","Vis 620","Vis 640","Vis 660"))+
  geom_hline(yintercept = 1,linetype="dotted")+ ##add a JND=1 line
  geom_point(data = mean.lf_twilight.model2, aes(x= "Vis1.lf", y= mean(Vis1.lf_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_twilight.model2, aes(x= "Vis2.lf", y= mean(Vis2.lf_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_twilight.model2, aes(x= "Vis3.lf", y= mean(Vis3.lf_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_twilight.model2, aes(x= "Vis4.lf", y= mean(Vis4.lf_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lf_twilight.model2, aes(x= "Vis5.lf", y= mean(Vis5.lf_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Leaf vs. Flower")+
  annotate("text", x = c("Vis1.lf", "Vis2.lf", "Vis3.lf","Vis4.lf","Vis5.lf"), y = 3, label =c("a","b","c","d","e")) #add stitistical info
...
lb_twilight.model2<-ggplot(mean.lb_twilight.model2, aes(x=vissys, y=mean.dS.lb,group=beetleID))+
  ...
  scale_x_discrete(limits = c("Vis1.lb", "Vis2.lb", "Vis3.lb","Vis4.lb","Vis5.lb"),
                   labels=c("Vis 580", "Vis 600","Vis 620","Vis 640","Vis 660"))+
  geom_hline(yintercept = 1,linetype="dotted")+ ##add a JND=1 line
  geom_point(data = mean.lb_twilight.model2, aes(x= "Vis1.lb", y= mean(Vis1.lb_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_twilight.model2, aes(x= "Vis2.lb", y= mean(Vis2.lb_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_twilight.model2, aes(x= "Vis3.lb", y= mean(Vis3.lb_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_twilight.model2, aes(x= "Vis4.lb", y= mean(Vis4.lb_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.lb_twilight.model2, aes(x= "Vis5.lb", y= mean(Vis5.lb_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Leaf vs. Beetle")+
  annotate("text", x = c("Vis1.lb", "Vis2.lb", "Vis3.lb","Vis4.lb","Vis5.lb"), y = 3, label =c("a","b","c","d","d")) #add stitistical info
...
bf_twilight.model2<-ggplot(mean.bf_twilight.model2, aes(x=vissys, y=mean.dS.bf,group=flowerID))+
  ...
  scale_x_discrete(limits = c("Vis1.bf", "Vis2.bf", "Vis3.bf","Vis4.bf","Vis5.bf"),
                   labels=c("Vis 580", "Vis 600","Vis 620","Vis 640","Vis 660"))+
  geom_hline(yintercept = 1,linetype="dotted")+ ##add a JND=1 line
  geom_point(data = mean.bf_twilight.model2, aes(x= "Vis1.bf", y= mean(Vis1.bf_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_twilight.model2, aes(x= "Vis2.bf", y= mean(Vis2.bf_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_twilight.model2, aes(x= "Vis3.bf", y= mean(Vis3.bf_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_twilight.model2, aes(x= "Vis4.bf", y= mean(Vis4.bf_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  geom_point(data = mean.bf_twilight.model2, aes(x= "Vis5.bf", y= mean(Vis5.bf_twilight.model2$dS)), 
             col="black", size=3)+ #add the mean point
  #change the x labels
  ggtitle("Beetle vs. Flower")+
  annotate("text", x = c("Vis1.bf", "Vis2.bf", "Vis3.bf","Vis4.bf","Vis5.bf"), y = 3, label =c("a","b","c","d","e")) #add stitistical info
