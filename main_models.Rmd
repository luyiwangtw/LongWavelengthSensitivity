...
* The spectral data were smoothed with the span = 0.1, and those < 0 were shifted to 0
...
* We created nine sensitivity curves peaking at 380, 460, 520, 580, 600, 620, 640, 660, 680 nm and classified them into 4 photoreceptor types based on their peaks: 
...
***
* For the second question, we tested how the contrast changed as peak sensitivity increased by systematically increasing the peak sensitivity of the LWS photoreceptor from 580-680 nm.
  + Visual systems used:
...
ggplot(peaks,aes(x=wl, y=value, col=peak))+
  ...
  scale_color_manual(
    values = c("darkorchid4", "dodgerblue3", "olivedrab4", "orange1", "orange3","darkorange3", "orangered1", "red2","red4"),
    labels=c("380 nm", "460 nm","520 nm", "580 nm", "600 nm", "620 nm", "640 nm", "660 nm", "680 nm" ),
    breaks=peak.order)+
  xlab("Wavelength (nm)")+ 
