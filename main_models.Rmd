...
```{r, fig.cap = "Figure caption: Reflectance spectra of selected beetles in Figure 1 in the paper"}
## Plot beetle spectra
...
```{r, fig.cap = "Figure caption: Reflectance spectra of selected plants in Figure 1 in the paper"}
