...
ggplot(datacombined, aes(x=wavelength, y=attracted))+
  geom_jitter(data=ymaze.Cflavopicta,height=0.01,width=5, alpha=0.5, size= 3, color="#FFB32E")+
  geom_jitter(data=ymaze.Cdimidiata,height=0.01,width=5, alpha=0.5, size= 3, color="#3062C6")+
  geom_ribbon(data=newdat1.Cf, alpha=0.3,fill="#FFB32E", aes(ymax=phi.Cf, ymin=plo.Cf))+
  geom_ribbon(data=newdat1.Cd, alpha=0.3, fill="#3062C6", aes(ymax=phi.Cd, ymin=plo.Cd))+ 
  geom_line(data=newdat1.Cf, aes(x=wavelength, y=attracted), color="#FFB32E")+
  geom_line(data=newdat1.Cd, aes(x=wavelength, y=attracted), color="#3062C6")+ 
