...
```{r, fig.cap="Sensitivity curves of the evenly spaced visual system (solid lines) and the unevenly spaced visual system (Vis 680; dotted lines).",echo=FALSE,message=FALSE, warning=FALSE}
