...
author: "Lu-Yi Wang^1^, Devi Stuart-Fox^1^, Geoff Walker^1^, Nicholas Roberts^2^ and Amanda Franklin^1^ <br></br> <br></br> ^1^The University of Melbourne <br></br> <br></br> ^2^University of Bristol"
...
* Two light environments: daylight and twilight (to represent red-shifted illumination).
    + daylight: __D65__ from Commission internationale de l’éclairage –CIE
...
#Compare contrasts between visual systems
