...
lf.contrast_d65.even.space <-rbind.data.frame(median(VS.fl_d65.even.space$dS),median(Vis5.lf_d65.model2$dS))
lb.contrast_d65.even.space <-rbind.data.frame(median(VS.bl_d65.even.space$dS),median(Vis5.lb_d65.model2$dS))
bf.contrast_d65.even.space <-rbind.data.frame(median(VS.bf_d65.even.space$dS),median(Vis5.bf_d65.model2$dS))
...
#Twilight
##list contrast from each comparison group
lf.contrast_twilight.even.space <- rbind.data.frame(median(VS.fl_twilight.even.space$dS),median(Vis5.lf_twilight.model2$dS))
lb.contrast_twilight.even.space <- rbind.data.frame(median(VS.bl_twilight.even.space$dS),median(Vis5.lb_twilight.model2$dS))
bf.contrast_twilight.even.space <- rbind.data.frame(median(VS.bf_twilight.even.space$dS),median(Vis5.bf_twilight.model2$dS))
...
#Summary
For all three comparison groups, VS 660 (unevenly spaced visual system) has significantly higher contrast than the evenly spaced visual system. This indicates that the minimal improvement or lack of improvement in contrast beyond 640 nm shown in the main text is not the result of uneven spacing between photoreceptors. 