...
* We used opsin-shifted LWS to test how the silter- and opsin-shifted LWS photoreceptors affect the contrasts. 
...
specsensbuprest.model1 <- read.csv("data/peak sensitivity_opsin shift_aim1.csv",header=TRUE) %>%
  as.rspec()
specsensbuprest.model2 <- read.csv("data/peak sensitivity_opsin shift_aim2.csv",header=TRUE) %>%
  as.rspec()
#import irradiance
